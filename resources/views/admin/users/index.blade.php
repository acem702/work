...
<div>
        ...
        <div>
            <label class="block text-sm font-medium text-gray-700 mb-1">Withdrawal Password</label>
            <input type="password" name="withdrawal_password" required minlength="6" maxlength="6"
                   class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary focus:border-transparent">
        </div>
